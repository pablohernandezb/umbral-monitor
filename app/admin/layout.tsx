          ...
          <nav className="p-4 space-y-2">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="font-medium">Domain Blocking</span>
              </div>
            </Link>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="font-medium">Gaceta Oficial</span>
              </div>
            </Link>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="font-medium">Fact-Check Feed</span>
              </div>
            </Link>

            <Link
              href="/admin/installing-democracy"
              className="block px-4 py-3 text-gray-300 hover:text-white hover:bg-gray-800/50 rounded-lg transition-colors"
            >
              <div className="flex items-center gap-3">
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span className="font-medium">Installing Democracy</span>
              </div>
            </Link>

            <Link
              href="/admin/installing-democracy/experts"
              className="block px-4 py-3 text-gray-300 hover:text-white hover:bg-gray-800/50 rounded-lg transition-colors"
            >
              <div className="flex items-center gap-3">
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span className="font-medium">Monitoring Experts</span>
              </div>
            </Link>
